...
from xlamr_stog.modules.embedding import Embedding
from xlamr_stog.modules.seq2vec_encoders.seq2vec_encoder import Seq2VecEncoder
...
class TokenCharactersEncoder(TokenEmbedder):
    ...
    :class:`~xl-amr.data.token_indexers.TokenCharactersIndexer`, which is a tensor of shape
